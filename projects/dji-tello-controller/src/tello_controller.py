...
class TelloController:
    def __init__(self, g, mass, L, max_angle, KF, KM):
        ...
        # Faster velocity and attitude loops help the vehicle translate
        # aggressively enough to reach random setpoints within the marking window.
        self.vel_controller = PIDController(13.0, 0.9, 0.40, [14, 14, 14])
        self.attitude_controller = PIDController(0.50, 0.025, 0.04, [1.8, 1.8, 1.8])
        self.rate_controller = PIDController(0.16, 0.28, 0.003, [0.25, 0.25, 0.25])
    ...
    def accel_to_angle(self, desired_accel, quat):
        ...
        norm_accel = np.linalg.norm(desired_accel[:2]) 
    ...
    def compute_control(
        ...
        desired_rate[2] = yaw_rate_setpoint  
